...
/* Constructors */
/****************/
static inline ASTNode* ASTNode_CompilationUnit_new(Arena* arena, char* fname) { ASTNode* node = (ASTNode*)Arena_malloc(arena, sizeof(ASTNode)+sizeof(CompilationUnit_Info)); CompilationUnit_Info* info = (CompilationUnit_Info*)(((char*)node) + sizeof(ASTNode)); node->typed_info = (void*)info; return node;}
static inline ASTNode* ASTNode_TopLevelDecl_new(Arena* arena, char* name) { ASTNode* node = (ASTNode*)Arena_malloc(arena, sizeof(ASTNode)+sizeof(TopLevelDecl_Info)); TopLevelDecl_Info* info = (TopLevelDecl_Info*)(((char*)node) + sizeof(ASTNode)); node->typed_info = (void*)info; return node;}
static inline ASTNode* ASTNode_EnumDecl_new(Arena* arena, char* name) { ASTNode* node = (ASTNode*)Arena_malloc(arena, sizeof(ASTNode)+sizeof(EnumDecl_Info)); EnumDecl_Info* info = (EnumDecl_Info*)(((char*)node) + sizeof(ASTNode)); node->typed_info = (void*)info; return node;}
static inline ASTNode* ASTNode_TraitDecl_new(Arena* arena, char* name) { ASTNode* node = (ASTNode*)Arena_malloc(arena, sizeof(ASTNode)+sizeof(TraitDecl_Info)); TraitDecl_Info* info = (TraitDecl_Info*)(((char*)node) + sizeof(ASTNode)); node->typed_info = (void*)info; return node;}
static inline ASTNode* ASTNode_ClassDecl_new(Arena* arena, char* name) { ASTNode* node = (ASTNode*)Arena_malloc(arena, sizeof(ASTNode)+sizeof(ClassDecl_Info)); ClassDecl_Info* info = (ClassDecl_Info*)(((char*)node) + sizeof(ASTNode)); node->typed_info = (void*)info; return node;}
static inline ASTNode* ASTNode_FunctionDecl_new(Arena* arena, char* name) { ASTNode* node = (ASTNode*)Arena_malloc(arena, sizeof(ASTNode)+sizeof(FunctionDecl_Info)); FunctionDecl_Info* info = (FunctionDecl_Info*)(((char*)node) + sizeof(ASTNode)); node->typed_info = (void*)info; return node;}
static inline ASTNode* ASTNode_CTypeDecl_new(Arena* arena, char* name, char* cname) { ASTNode* node = (ASTNode*)Arena_malloc(arena, sizeof(ASTNode)+sizeof(CTypeDecl_Info)); CTypeDecl_Info* info = (CTypeDecl_Info*)(((char*)node) + sizeof(ASTNode)); node->typed_info = (void*)info; return node;}
static inline ASTNode* ASTNode_GlobalVarDecl_new(Arena* arena, char* name, char* type) { ASTNode* node = (ASTNode*)Arena_malloc(arena, sizeof(ASTNode)+sizeof(GlobalVarDecl_Info)); GlobalVarDecl_Info* info = (GlobalVarDecl_Info*)(((char*)node) + sizeof(ASTNode)); node->typed_info = (void*)info; return node;}
static inline ASTNode* ASTNode_Expression_new(Arena* arena, char* method, List_ASTNode on_list, bool compile) { ASTNode* node = (ASTNode*)Arena_malloc(arena, sizeof(ASTNode)+sizeof(Expression_Info)); Expression_Info* info = (Expression_Info*)(((char*)node) + sizeof(ASTNode)); node->typed_info = (void*)info; return node;}
