...
#define __STILTS_SANITY_FAIL() __Stilts_default_sanity_check_fail(__STILTS_SRC_INFO)
#define __STILTS_ERROR(message) __Stilts_default_error(message, __STILTS_SRC_INFO)
