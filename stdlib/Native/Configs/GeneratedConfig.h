...
#define __DAI_PYTHON_VERSION "3.9.7"
#define __DAI_PYTHON_MAJOR_VERSION 3
#define __DAI_PYTHON_MINOR_VERSION 9
#define __DAI_PYTHON_SUBMINOR_VERSION 7

#define __DAI_HAS_ANSI_COLORS 1

#define __DAI_HAS_BACKTRACES 0

#define __DAI_HAS_LABEL_VALUES 1
#endif // __DAI_STDLIB_GENERATEDCONFIG
