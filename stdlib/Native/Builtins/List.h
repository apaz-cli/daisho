...
#define _DAI_LIST_DEFINE(type)                                                         \
    static inline _Dai_List_##type _Dai_List_##type##_new() {                          \
        _Dai_List_##type nl;                                                           \
        nl.buf = NULL;                                                                 \
        nl.len = 0;                                                                    \
        nl.cap = 0;                                                                    \
    ...
    static inline int _Dai_List_##type##_add(_Dai_List_##type* self, type item) {      \
    ...
    static inline type _Dai_List_##type##_get(_Dai_List_##type* self, size_t idx) {    \
        _DAI_SANE_ASSERT(self, "List is null.");                                       \
        _DAI_SANE_ASSERT(idx < self->len, "List index out of range.");                 \
        return self->buf[idx];                                                         \
    }                                                                                  \
    static inline type _Dai_List_##type##_remove(_Dai_List_##type* self, size_t idx) { \
        _DAI_SANE_ASSERT(self, "List is null.");                                       \
        _DAI_SANE_ASSERT(idx < self->len, "List index out of range.");                 \
    ...
    static inline bool _Dai_List_##type##_isEmpty(_Dai_List_##type* self) {            \
        return self->len == 0;                                                         \
    }                                                                                  \
    static inline void _Dai_List_##type##_clear(_Dai_List_##type* self) {              \
